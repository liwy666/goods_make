...
export default new Vuex.Store({
    state: {
        ...
        into_type: 'redBullMake-hw',
        back_url:'http://mate.ganglonggou.com/make/red_bull_hw',
        share_url:'http://mate.ganglonggou.com/make/red_bull_hw',
        location_url:'http://mate.ganglonggou.com/goods_make/red_bull_hw/',
        goods_info: {
            goods_gallery: [],//商品相册
            goods_sku_list: [],//sku表
            goods_number: 1,//商品数量
